...
initTerm:
            ...
            and       byte [lflag], ~echo     ; disable echo
            and       byte [lflag], ~icanon   ; disable canonical mode
...
resetTerm:
            ...
            or        byte [lflag], echo      ; disable echo
            or        byte [lflag], icanon    ; disable canonical mode
